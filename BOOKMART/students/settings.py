...
TEMPLATES = [
    {
        ...
        'DIRS':[BASE_DIR / 'templates'],  # Use Path for better compatibility
...
MEDIA_ROOT=BASE_DIR / 'media'  # Use Path for better compatibility
X_FRAME_OPTIONS = 'SAMEORIGIN'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
#os.environ['DJANGO_SETTINGS_MODULE'] = 'bookmart_project.settings'
